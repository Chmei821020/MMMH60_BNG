...
<!--/* 以下請放入自己頁面的css連結和必要的套件css檔案，css檔案請統一存在css資料夾中-->
<!--ex: <link rel="stylesheet" href="/css/XXXX.css">-->
<!--以上請放入自己頁面的css連結必要的套件css檔案，css檔案請統一存在css資料夾中＊/-->

</head>
<?php include __DIR__. '/parts/BNG_navbar_topButton_Vv.php'; ?>

<!--/* 以下請放入自己頁面的html內頁結構（除去head, navbar,top button, footer等等)-->
<!--*/-->
